    ...
    // login ,,,,,,,,,,,,,,,,,,,,,,,,,,,,,,,,,,,,,,,,,,,,,,,,,,,,,,,,,,,,,,,,,,,,,,,,,,,,,,,,,,,,,,,,,,,,,,,,,,,,,,,,,,,,,,,,,,,,,,,,,,,
     ...
     static login = async (req,res) => {
        try{
            ...
            res.status(200).send({apiStatus:true , data:userData , token:token , message:"user loggined and authentication successfuly"})
        }
        catch(e){
            res.status(500).send({apiStatus:false , data:e , message:e.message})
        }
     ...
     static me = async(req,res)=>{
        res.status(200).send({apiStatus:true , data:req.user , message:"logined sucessfly"})
    }
     ...
     // edit user ,,,,,,,,,,,,,,,,,,,,,,,,,,,,,,,,,,,,,,,,,,,,,,,,,,,,,,,,,,,,,,,,,,,,,,,,,,,,,,,,,,,,,,,,,,,,,,,,,,,,,,,,,,,,,,,,,,,,,,,
      ...
      static editUser = async(req,res) => {
        try{
            const allowedEdits = ["username","email","profilePic","cart"]
      ...
      static addImg = async (req,res)=>{
        try{
            req.user.profilePic = req.file.path.replace("app\\static\\","")
            await req.user.save()
            res.status(200).send({apiStatus:true, data:req.user, MessageEvent:"done"})
        }
        catch(e){
